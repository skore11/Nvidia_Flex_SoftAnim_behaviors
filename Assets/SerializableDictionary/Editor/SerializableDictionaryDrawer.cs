...
public abstract class SerializableKeyValueTemplate</*A,*/ K, V> : ScriptableObject {
    //public A name;
    public K key;
    public V value;
}
 
public abstract class SerializableDictionaryDrawer</*A,*/ K, V> : PropertyDrawer {
 
    protected abstract SerializableKeyValueTemplate</*A,*/ K, V> GetTemplate();
    protected T GetGenericTemplate<T>() where T: SerializableKeyValueTemplate</*A,*/ K, V> {
